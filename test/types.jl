...
@testset "Search type" begin
    ...
    @test_throws UndefKeywordError Search(country = "pt", operation = "sale")
    @test_throws UndefKeywordError Search(
        country = "uk",
        operation = "sale",
        propertyType = "homes",
    )
    # either distance of locationId are required
    @test_throws ErrorException Search(
        country = "uk",
        operation = "sale",
        propertyType = "homes",
        center = "42.3,-3.7",
    ...
    @test_throws DomainError Search(
        country = "uk",
        operation = "sale",
        propertyType = "homes",
        center = "42.3,-3.7",
    ...
    # outer constructor
    def1 = Search("es", "sale", "offices", "42.2,-3.7", distance = 1500)
    @test def1.locale == "en"

    def2 = Search("es", "sale", "offices", "42.2,-3.7", locationId = "Id1500")
    @test def2.locale == "en"

    def3 = Search("es", "sale", "offices", "42.2,-3.7", distance = 1500, locale = "ca")
    @test def3.locale == "ca"

    @test_throws ErrorException Search("es", "sale", "offices", "42.2,-3.7", locale = "ca")
...
@testset "Garages type" begin
    ...
    empty = Garages()
    @test isa(empty, IdealistaAPIClient.PropertySearchFields)
